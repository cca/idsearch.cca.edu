...
<script type="text/javascript" language="javascript" charset="utf-8" src="include/inventory2.js"></script>
...
function ajaxFunction(){
	...
	var url = "ajax2.php?user_id=" + escape(user_id);
...
echo('<form name="inventory" method="post" action="db_update2.php"><br>
<input type="hidden" name="user_id" id="userid" value="'.$user_id.'" size="3" />
<table class="form"><tr><td valign=top><h4>User</h4></td><td valign=top><h4>Location</h4></td><td valign=top><h4>Device</h4></td><td valign=top><h4>Network</h4></td><td valign=top><h4>Display</h4></td></tr>
...
<select name="mtype">
	...
	<option value="Deployed Computer">Deployed Computer</option>
	<option value="Undistributed Computer">Undistributed Computer</option>
	<option value="Deployed Loaner">Deployed Loaner</option>
	<option value="Undeployed Loaner">Undeployed Loaner</option>
	<option value="Recycled Computer">Recycled Computer</option>
	<option value="Missing Computer">Missing Computer</option>
    <option value="Sold Computer">Sold Computer</option>
    <option value="Stolen Computer">Stolen Computer</option>
	<option value="Parts Computer">Parts Computer</option>
...
<strong>Processor Type: </strong><br>
	...
	<strong>Deployment type: </strong><br>
	<select name="processor">
	<option value="">Select type</option>
	<option value="Staff">Staff</option>
	<option value="Temp Staff">Temp Staff</option>
...
<strong>Hard drive: </strong><br>
	...
	<option value="321 - 500 GB">321 - 500 GB</option>
	<option value="501 GB - 1 TB">501 GB - 1 TB</option>
	</select><br><br>
<strong>Model Year: </strong><br>
	<select name="optical">
	<option value="">Select year</option>
	<option value="Pre-2007">Pre-2007</option>
...
<hr><input type="submit" value="Update Record" />&nbsp;&nbsp;<input type="reset" value="Reset Form" />
</form>');
?>
</div>
</body>
