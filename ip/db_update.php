...
$query = "UPDATE master SET ip_addr='$ip', ip_type='$ip_type', ip_avail='$avail', device_type='$device_type', model='$model', serial='$serial', asset='$asset', campus='$campus', bldg='$bldg', location='$location', dns='$dns', mac_addr='$mac', dept='$dept', uname='$uname', notes='$notes' WHERE ip_addr='$ip'";
