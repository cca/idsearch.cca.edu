...
{
case 0:
	$query = "SELECT * FROM master WHERE ip_addr like '%$x1%' AND ip_addr like '%$x2%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 1:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '10.4%' AND '10.5%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 2:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.82%' AND '209.40.84%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 3:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.84%' AND '209.40.86%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 4:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.86%' AND '209.40.88%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 5:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.92%' AND '209.40.94%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
case 6:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.94%' AND '209.40.95%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND uname like '%$x10%'";
	$result = mysql_query($query);
	break;
}
...
<script src="/ip/include/ip.js" type="text/javascript"></script>
<script src="/ip/include/sorttable.js" type="text/javascript"></script>
</head>
<body>
<div id="header">
