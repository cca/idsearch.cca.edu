...
#******* LDAP Settings *******#
// ldap server
DEFINE('LDAP_SERVER', 'directory.cca.edu');  // use ldaps://hostname/ for connetion over SSL
// ldap port
...
// bind rdn
DEFINE('LDAP_BIND_RDN', 'uid=search,ou=Administrators,ou=TopologyManagement,o=NetscapeRoot');
// bind password
DEFINE('LDAP_BIND_PASSWORD', 'RhoacEgjogEd');
// base dn for search
DEFINE('LDAP_BASE_DN', 'OU=People,DC=cca,DC=edu');
// search filter
