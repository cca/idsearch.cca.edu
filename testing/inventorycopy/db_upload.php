...
if (($_FILES["file"]["size"] < 2000000)) {
  if ($_FILES["file"]["error"] > 0) {
    ...
    if (file_exists("uploads/" . $_FILES["file"]["name"]))
      ...
      echo "Stored in: " . "/Sites/idsearch.cca.edu/documents/inventorycopy/uploads/" . $_FILES["file"]["name"] . "<br />";
...
$query = "LOAD DATA LOCAL INFILE 'uploads/$file' INTO TABLE master_copy FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n'";
