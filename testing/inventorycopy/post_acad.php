...
<head>
<title>CCA Academic Computing Inventory</title>
...
<tr>
<td id="logo"><a href="acadcomp.php">Academic Computing Inventory Database</a></td>
<td id="links"><?php echo date ("l - F j, Y");?><br>
<a href="acadcomp.php">Search Database</a> : : <a href="post_acad.php">Add Entry</a> : : <a href="update.php">Update Entry</a> : : <a href="delete.php">Delete Entry</a> : : <a href="upload.php">Upload File</a></td>
</tr>
</table></center>
</div>
<div id="addstrip">
...
if ($uname != NULL || $labselect != NULL || $dept != NULL || $campus != NULL || $bldg != NULL || $floor != NULL || $room != NULL || $mtype != NULL || $platform != NULL || $model != NULL || $othermodel != NULL || $asset != NULL || $serial != NULL || $service != NULL || $processor != NULL || $proc_type != NULL || $ram != NULL || $disk != NULL || $optical != NULL || $mname != NULL || $ip != NULL || $mac != NULL || $display_model != NULL || $display_size != NULL || $display_asset != NULL || $display_serial != NULL || $notes != NULL) {
post_db($uname, $labselect, $dept, $campus, $bldg, $floor, $room, $mtype, $platform, $model, $othermodel, $asset, $serial, $service, $processor, $proc_type, $ram, $disk, $optical, $mname, $ip, $mac, $display_model, $display_size, $display_asset, $display_serial, $notes);
}
else {
...
<strong>Room: </strong><br>
	<input type="text" name="room" size="10" maxlength="50" /> <br><br>
	
	
	
	
	<strong>Located in a lab?  (must first select a campus)</strong><br>
