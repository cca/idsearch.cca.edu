...
{
case 0:
	$query = "SELECT * FROM master WHERE ip_addr like '%$x1%' AND ip_addr like '%$x2%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 1:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '10.4%' AND '10.5%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 2:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.82%' AND '209.40.84%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 3:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.84%' AND '209.40.86%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 4:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.86%' AND '209.40.88%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 5:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.92%' AND '209.40.94%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
case 6:
	$query = "SELECT * FROM master WHERE ip_addr BETWEEN '209.40.94%' AND '209.40.95%' AND ip_type like '%$x4%' AND ip_avail like '%$x5%' AND device_type like '%$x6%' AND campus like '%$x7%' AND bldg like '%$x8%' AND dept like '%$x9%' AND dns like '%$x10%'";
	$result = mysql_query($query);
	break;
}
...
<script src="/ipcopy/include/sorttable.js" type="text/javascript"></script>
</head>
<body>
<div id="header">
...
if ($ipaddr != NULL || $subnet != NULL || $range != NULL || $ip_type != NULL || $avail != NULL || $device_type != NULL || $campus != NULL || $bldg != NULL || $dept != NULL || $dns) {
query_db($ipaddr, $subnet, $range, $ip_type, $avail, $device_type, $campus, $bldg, $dept, $dns);
}
else {
echo ('<form name="iptrack" action="'.$_SERVER["PHP_SELF"].'" method="GET">');
echo ("<h3>Search by any combination:</h3><hr>");
echo ('<table class="form"><tr><td valign=top><h4>Network</h4></td><td valign=top><h4>Location</h4></td><td valign=top><h4>Device</h4></td><td valign=top><h4>DNS name</h4></td></tr>
...
<td valign=top><strong>DNS: </strong><br>
<input type="text" name="dns" size="20" maxlength="50" /></td></tr>
</table><br><hr>
