...
$query = "INSERT INTO master_copy (ip_addr, ip_type, ip_avail, device_type, model, serial, asset, campus, bldg, location, dns, mac_addr, dept, uname, notes) VALUES ('$x1', '$x2', '$x3', '$x4', '$x5', '$x6', '$x7', '$x8', '$x9', '$x10', '$x11', '$x12', '$x13', '$x14', '$x15')";
