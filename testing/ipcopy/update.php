...
<head>
<title>CCA Printer/Network Inventory</title>
<script type="text/javascript" language="javascript" charset="utf-8" src="/ipcopy/include/ip.js"></script>
...
function ajaxFunction(){
	...
	var url = "ajax.php?ip_addr=" + escape(ip);
...
<div id="content">
<form name="iptrack" method="post" action="../ipcopy/db_update.php">
<table class="form">
<tr><strong>Enter IP address of record to update:</strong><br>
<input type="text" id="ipaddress" value="" onkeyup="ajaxFunction();" size="15"></tr><br><br><hr>
<tr><td valign=top><h4>Network</h4></td><td valign=top><h4>Location</h4></td><td valign=top><h4>Device</h4></td><td valign=top><h4>User</h4></td><td valign=top><h4>Notes</h4></td></tr>
<tr><td valign=top><strong>IP Address:</strong><br>
<input type="text" name="ipaddr" id="ipaddr" size="20" /><br><br>
